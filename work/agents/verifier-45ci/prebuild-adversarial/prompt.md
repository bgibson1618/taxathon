...
Your lens:
ADVERSARIAL — challenge the plan's premises. Hunt for: assumptions (stated or unstated) the artifacts depend on but never establish; success criteria readable two ways — would two honest reviewers disagree on whether one is met?; proof methods too weak for what their feature claims; dependencies that contradict the prose around them; anything the documents treat as settled that is actually an open choice.
...
- Your run directory: /home/brent-gibson/projects/taxathon/work/agents/verifier-45ci/prebuild-adversarial
- Output file: /home/brent-gibson/projects/taxathon/work/agents/verifier-45ci/prebuild-adversarial/output.md
- Terminal log: /home/brent-gibson/projects/taxathon/work/agents/verifier-45ci/prebuild-adversarial/terminal.log
- Pane file: /home/brent-gibson/projects/taxathon/work/agents/verifier-45ci/prebuild-adversarial/pane
- Questions for the user: /home/brent-gibson/projects/taxathon/work/agents/verifier-45ci/prebuild-adversarial/questions.md
- Notes from the user/orchestrator: /home/brent-gibson/projects/taxathon/work/agents/verifier-45ci/prebuild-adversarial/inbox.md
...
captured verbatim to `/home/brent-gibson/projects/taxathon/work/agents/verifier-45ci/prebuild-adversarial/output.md` automatically — that capture IS the deliverable, so it
